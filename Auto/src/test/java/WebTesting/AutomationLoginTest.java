...
public class AutomationLoginTest {
    ...
    public void loginTest(){
        ...
        usernameTextField.sendKeys("Shelby");
        ...
        passwordTestField.sendKeys("Shelby");
        ...
        Assert.assertEquals(webDriver.getCurrentUrl(),"http://training.skillo-bg.com:4200/users/5465");
    }
    ...
    public void homePageScrollTest() {
        ...
        js.executeScript("window.scrollBy(0, 2 750)", "");
